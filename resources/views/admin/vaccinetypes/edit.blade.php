...
@section('formpage')
<form action="{{ route('vaccinetype.update',$vtype->id) }}" method="POST" onsubmit="return validatesubmission()" >
@csrf
 @method('PATCH')
<div class="row">
	<div class="col-lg-12">
		<div class="form-group">
			...
			<input type="text" name="vname" id="vname" class="form-control" placeholder="Enter vaccine Name" value="{{ $vtype->vname }}" >
		</div>
	</div>
	<div class="col-lg-12">
		<div class="form-group">
        Description: <span class="errmsg" id="id_description"></span>
			<textarea type="text" class="form-control" id="description" name="description" placeholder="Description" >{{ $vtype->description }}</textarea>
		</div>
	</div>
    ...
    <div class="col-lg-6">
		<div class="form-group">
			...
			<input type="number" name="period" id="period" class="form-control" min="0" placeholder="Vaccine period" value="{{ $vtype->period }}" >
		</div>
	</div>
    <div class="col-lg-6">
		<div class="form-group">
			Due Date for 2nd Dose.: <span class="errmsg" id="id_seconddose"></span>
			<input type="number" name="seconddose" id="seconddose" class="form-control" min="0" placeholder="Due Date for 2nd Dose."  value="{{ $vtype->seconddose }}" >
		</div>
	</div>
    <div class="col-lg-6">
		<div class="form-group">
			Cost (Only for Paid Category): <span class="errmsg" id="id_cost"></span>
			<input type="number" name="cost" id="cost" class="form-control" min="0" placeholder="Vaccine cost"   value="{{ $vtype->cost }}" >
		</div>
	</div>
	<div class="col-lg-6">
		<div class="form-group">
